...
!function (y, M, L, a) {
    y.fn.flipBook = function (e) {
        ...
        deeplinkingPrefix: "",
        assets: {
            preloader: "/frontend/js/deploy/images/preloader.jpg",
            overlay: "/frontend/js/deploy/images/overlay.png",
            flipMp3: "/frontend/js/deploy/mp3/turnPage.mp3",
            spinner: "/frontend/js/deploy/images/spinner.gif"
        },
        pdfUrl: null,
        ...
        var o, i, s, a = L.createElement("div").style, r = function () {
        ...
        }), S.lightBoxOpened ? (O(), y(M).trigger("r3d-lightboxloadingstarted")) : S.lightboxPreload && ("undefined" != typeof IScroll || FLIPBOOK.scriptsAdded[FLIPBOOK.iscrollSrc] || n.loadScript(FLIPBOOK.iscrollSrc, function () {
        }), void 0 !== FLIPBOOK.PdfService || FLIPBOOK.scriptsAdded[FLIPBOOK.pdfServiceSrc] || n.loadScript(FLIPBOOK.pdfServiceSrc, function () {
        }), S.pdfMode && ("undefined" != typeof pdfjsLib || FLIPBOOK.scriptsAdded[FLIPBOOK.pdfjsSrc] || n.loadScript(FLIPBOOK.pdfjsSrc, function () {
        }), void 0 !== FLIPBOOK.PdfService || FLIPBOOK.scriptsAdded[FLIPBOOK.pdfServiceSrc] || n.loadScript(FLIPBOOK.pdfServiceSrc, function () {
        ...
        }))), this.fullscreenElement = L.documentElement) : (S.btnClose.enabled = !1, this.preloader.appendTo(this.wrapper), this.wrapper.appendTo(this.$elem), this.fullscreenElement = this.$elem[0], O()))
        ...
        start: function () {
            ...
            var e, t = M.location.hash, o = "#" + this.options.deeplinkingPrefix;
            ...
            1 == this.options.numPages && (this.options.viewMode = "swipe", this.options.singlePageMode = !0, this.webgl = !1), this.loadPage(0, this.options.pageTextureSize, function () {
                ...
                1 == n.pages.length ? (e = n.pages[0].img, n.pw = e.width, n.ph = e.height, n.pageWidth = e.width, n.pageHeight = e.height, n.pageMode = "singlePage", n.doublePage = !1, n.zoomSize = n.zoomSize || e.height, s.setLoadingProgress(.7), n.btnNext.enabled = !1, n.btnPrev.enabled = !1, n.btnFirst.enabled = !1, n.btnLast.enabled = !1, n.sideNavigationButtons = !1, n.btnAutoplay.enabled = !1, s.start()) : s.loadPage(1, n.pageTextureSize, function () {
                    var e = n.pages[0].img, t = n.pages[1].img, o = e.width / e.height, i = t.width / t.height;
            ...
            var o = this.options.pages[e] || {}, i = this;
            ...
            var i, n = this, s = this.options.pages && this.options.pages[e] && this.options.pages[e].src;
            ...
            var n = this, s = L.createElement("script"), e = L.getElementsByTagName("script")[0];
            ...
            var e, n = this, t = this.model, o = this.options;
            ...
            if (this.options.numPages = this.options.pages.length, this.options.numPages % 2 == 0 || this.options.singlePageMode || (this.oddPages = !0, this.options.oddPages = !0, this.options.pages.push({
                ...
                empty: !0
            })), 0 < n.options.pages.length) for (s = 0; s < n.options.pages.length; s++) void 0 !== n.options.pages[s].htmlContent && (n.options.hasHtmlContent = !0, n.options.pages[s].htmlContent = y(n.options.pages[s].htmlContent));
            ...
            var o = this.options, e = "top" == t.vAlign && o.menu2Transparent || "top" != t.vAlign && o.menuTransparent,
                ...
                p = y(L.createElement("span")), c = "material" == o.icons,
                u = c ? (t.size || o.btnSize) + 8 : t.size || o.btnSize, g = (t.size || o.btnSize) + 24;
            ...
            p.$icon = this.createIcon(t).appendTo(p), f(p.$icon), t.iconAlt2 && (p.$iconAlt = this.createIcon(t, !0).appendTo(p).hide(), f(p.$iconAlt)), p.icon = t.icon, p.iconAlt = t.iconAlt, c && (p.icon = t.icon2, p.iconAlt = t.iconAlt2, t.icon = t.icon2, t.iconAlt = t.iconAlt2), t.onclick && p.bind("tap click", function (e) {
                ...
                p.find("." + p.icon.replace("fas ", "")).css({
                    color: a,
                    background: n
                }), p.$iconAlt && p.find("." + p.iconAlt.replace("fas ", "")).css({color: a, background: n})
            }).mouseleave(function () {
                p.find("." + p.icon.replace("fas ", "")).css({
                    color: s,
                    background: i
                }), p.$iconAlt && p.find("." + p.iconAlt.replace("fas ", "")).css({color: s, background: i})
            });
            ...
            var o, i, n, s, a, r = y(e).attr("data-name"), l = this.options;
            switch (r) {
                case"btnFirst":
                    this.firstPage();
                    break;
            ...
            var o = this, i = this.options, e = "flipbook-currentPageHolder ",
            ...
            var i = this, n = y("<div>").addClass("flipbook-menu-header skin-clor flipbook-font").appendTo(e),
            ...
            var i = this, e = this.options.tableOfContent;
            if (e && e.length || !this.pdfService || this.pdfService.outlineLoaded) {
                ...
                } else for (var o = this.options.pages, t = 0; t < o.length; t++) {
                    var n, s = o[t].title;
                ...
                var t = new EventBus, o = {
                    scrollPageIntoView: function (e) {
                        var t = e.pageNumber, o = $annotations[processingAnnotationIndex];
            ...
            var n = this, e = e || this.tocScroller, o = this.options.rightToLeft,
                s = y(L.createElement("a")).attr("class", "flipbook-tocItem").addClass("skin-color").css("direction", o ? "rtl" : "ltr").appendTo(e).bind("touchend click", function (e) {
                    ...
                    function o(e) {
                        n.pdfService.pdfDocument.getPageIndex(e[0]).then(function (e) {
                            var t = e + 1, t = n.options.rightToLeft ? n.options.pages.length - t + 1 : t;
                            setTimeout(function () {
                                n.goToPage(t)
                            }, 200)
                        })
        ...
        var a = this, i = o.options, e = o.wrapper;
        ...
        this.search = y("<div>").addClass("flipbook-search").appendTo(this.thumbHolder).hide(), this.$searchBar = y('<div class="flipbook-findbar" id="findbar" deluminate_imagetype="png"><div id="findbarInputContainer"><input id="findInput" class="toolbarField" title="Find" placeholder="' + i.strings.findInDocument + '..."></div><div class="flipbook-find-info skin-color"/></div>').appendTo(this.search), this.$findInput = this.$searchBar.find("#findInput").keyup(function () {
            var i = this.value;
            if ("" != i) {
                var o = a.main, e = o.pdfService, n = o.options;
                if (a.hideAllThumbs(), a.pagesFound = 0, a.$findInfo.hide(), o.unmark(), o.searchingString = i, e) for (var t = 0; t < e.pdfInfo.numPages; t++) e.findInPage(i, t, function (e, t, o) {
                    0 < e && (a.showThumb(o), a.pagesFound++, a.$findInfo.show().text(a.pagesFound + " " + n.strings.pagesFoundContaining + ' "' + i + '"'), a.main.mark(i))
                }); else for (t = 0; t < n.pagesOriginal.length; t++) {
                    var s = t;
        ...
        var t = i.pages, n = [];
        if (i.doublePage) for (var s = 0; s < t.length; s++) 0 != s && s % 2 == 0 || n.push(t[s]); else n = t;
        ...
        for (var r = i.thumbSize, l = i.thumbSize * i.pageWidth / i.pageHeight, s = 0; s < n.length; s++) {
            ...
            if (!n[s].empty) {
                ...
                if (this.thumbs.push(h), n[s].thumbCanvas) var c = y(n[s].thumbCanvas); else {
                    if (!d) continue;
                ...
                var u = i.doublePage && i.pages.length % 2 == 0 && s == n.length - 1, g = i.doublePage && 0 == s,
                    f = i.doublePage && !g && !u;
        ...
        loadThumbsFromPdf: function (e) {
            ...
            this.main.pdfDocument.getPage(e + 1).then(function (e) {
                var t = e.getViewport({scale: 1}), o = l.options.thumbSize / t.height, i = e.getViewport({scale: o}),
    ...
    function i(e, f) {
        ...
        var f = re.extend({}, f), E = Le || Ie || !f.fallbackToMouseEvents,
            A = E ? Ie ? Ce ? "MSPointerDown" : "pointerdown" : "touchstart" : "mousedown",
            _ = E ? Ie ? Ce ? "MSPointerMove" : "pointermove" : "touchmove" : "mousemove",
            D = E ? Ie ? Ce ? "MSPointerUp" : "pointerup" : "touchend" : "mouseup", K = !E || Ie ? "mouseleave" : null,
            H = Ie ? Ce ? "MSPointerCancel" : "pointercancel" : "touchcancel", R = 0, N = null, j = null, W = 0, V = 0,
            U = 0, $ = 1, q = 0, Z = 0, Q = null, G = re(e), Y = "start", X = 0, J = {}, ee = 0, te = 0, oe = 0, ie = 0,
            ne = 0, se = null, ae = null;
        try {
    ...
    var le = "left", de = "right", he = "up", pe = "down", ce = "in", ue = "out", ge = "none", fe = "auto",
        be = "swipe", me = "pinch", ke = "tap", ve = "doubletap", we = "longtap", Pe = "horizontal", Se = "vertical",
        Be = "all", xe = 10, Oe = "start", Te = "move", ye = "end", Me = "cancel", Le = "ontouchstart" in window,
    ...
    "classList" in document.documentElement || !Object.defineProperty || "undefined" == typeof HTMLElement || Object.defineProperty(HTMLElement.prototype, "classList", {
        get: function () {
            function e(i) {
                return function (e) {
                    var t = n.className.split(/\s+/), o = t.indexOf(e);
    ...
    return function (e, t) {
        ...
        var e, t, o, i = this.config.networks, n = [];
        for (t in i) {
